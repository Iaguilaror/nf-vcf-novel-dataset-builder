...
## For debugging only
# args[1] <- "test/data/sampleshr22.removed_singletons_and_private.novel.count_block.tmp"
# args[2] <- "test/data/sampleshr22.removed_singletons_and_private.novel.counts.tsv"
